...
public class UnlikeCriticReviewCommandHandler(IUnitOfWork _unitOfWork) : ICommandHandler<UnlikeCriticReviewCommand>
{
    public async Task<Response> Handle(UnlikeCriticReviewCommand request, CancellationToken cancellationToken)
    {
